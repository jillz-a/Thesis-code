...
test_paths = ['denoised-NOCF', 'denoised-CF-combined', 'denoised-CF_RUL_increase-combined', 'denoised-CF_RUL_decrease-combined', 'denoised-CF_RUL_increase_decrease-combined']
names = ['Baseline', 'Augmented \n Uncertainty CF', 'Augmented \n RUL CF (increasing)', 'Augmented \n RUL CF (decreasing)', 'Augmented \n RUL CF (combined)']
...
for i, key in enumerate(key_ranges):
    ...
    axs[0,i].boxplot(list(total_RMSE_dict[key].values()), labels=names, positions=positions)
    ...
    axs[1,i].boxplot(total_std_dict[key].values(), labels=names, positions=positions)
    axs[1,i].set_ylim(bottom=0, top=15)
    ...
    axs[2,i].boxplot(total_alpha_dict[key].values(), labels=names, positions=positions)
